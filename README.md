...
This repository is used to host the sncell base that the Doridot team will use for their snCell analysis.
...
As those steps have to be experimented with, we encourage users to personnalise the config file. 
